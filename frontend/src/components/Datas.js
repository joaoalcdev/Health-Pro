...
export const brStateDatas = {
  states: [
    ...
    { id: 5, "name": "Amazonas", "UF": "AM" },
    { id: 6, "name": "Amazonas", "UF": "AM" },
    { id: 7, "name": "Bahia", "UF": "BA" },
    { id: 8, "name": "Ceará", "UF": "CE" },
    { id: 9, "name": "Distrito Federal", "UF": "DF" },
    { id: 10, "name": "Espírito Santo", "UF": "ES" },
    { id: 11, "name": "Goiás", "UF": "GO" },
    { id: 12, "name": "Maranhão", "UF": "MA" },
    { id: 13, "name": "Mato Grosso", "UF": "MT" },
    { id: 14, "name": "Mato Grosso do Sul", "UF": "MS" },
    { id: 15, "name": "Minas Gerais", "UF": "MG" },
    { id: 16, "name": "Pará", "UF": "PA" },
    { id: 17, "name": "Paraíba", "UF": "PB" },
    { id: 18, "name": "Paraná", "UF": "PR" },
    { id: 19, "name": "Pernambuco", "UF": "PE" },
    { id: 20, "name": "Piauí", "UF": "PI" },
    { id: 21, "name": "Rio de Janeiro", "UF": "RJ" },
    { id: 22, "name": "Rio Grande do Norte", "UF": "RN" },
    { id: 23, "name": "Rio Grande do Sul", "UF": "RS" },
    { id: 24, "name": "Rondônia", "UF": "RO" },
    { id: 25, "name": "Roraima", "UF": "RR" },
    { id: 26, "name": "Santa Catarina", "UF": "SC" },
    { id: 27, "name": "São Paulo", "UF": "SP" },
    { id: 28, "name": "Sergipe", "UF": "SE" },
    { id: 29, "name": "Tocantins", "UF": "TO" }
  ]
}
