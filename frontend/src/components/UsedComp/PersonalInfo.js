...
function PersonalInfo({ titles }) {
  ...
  return (
    <div className="flex-colo gap-4">
      ...
      {/* fullName */}
      <Input label="Nome completo" color={true} type="text" />
      {/* phone */}
      <Input label="Nº Contato" color={true} type="number" />
      {/* phone */}
      <Input label="Nº Contato Emergência" color={true} type="number" />
      {/* cpf */}
      <Input label="CPF" color={true} type="number" />
      {!titles && (
        <>
          {/* gender */}
          <div className="flex w-full flex-col gap-3">
